...
while admin.phps isn't found, index.phps is. I had to google what the difference between php and phps was:
```
...
this code shows `authentication.php`, which contains:
